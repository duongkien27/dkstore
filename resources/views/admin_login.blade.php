...
<div class="w3layouts-main">
	...
	?>
		...
		<a style="color: blue;" href="{{url('/login-facebook')}}"><button style="margin-left: 50px;border-radius: 5px"><i class="fa fa-facebook-square"></i> Đăng nhập bằng tài khoản Facebook</button></a>
</div>
</div>
